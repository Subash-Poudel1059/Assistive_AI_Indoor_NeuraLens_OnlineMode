...
🚀 Usage
To start the NeuraLens Online Assistant:
code
Bash
python main.py --mode online --device 0
--mode: Specifies the online processing engine.
--device: Index of the camera/video input.